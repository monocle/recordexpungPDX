    ...
    <main>
      <div className="bg-navy pv6">
        <div className="mw7 center white pa4">
          <h1 className="f3 f2-ns fw9 lh-tight mt0 mb4">
            RecordSponge is a web application used to facilitate the expungement
            process in Oregon.
          </h1>
          <p className="f4 lh-copy">
            RecordSponge is a collaboration between Code for PDX and Qiu-Qiu
            Law. This project is an entirely volunteer effort and is part of the
            open tech group Code for PDX, a brigade of Code for America.
          </p>
        </div>
      </div>
      <div className="bg-lightest-blue1 navy pv6">
        <div className="mw7 center pa4">
          ...
          <p className="f4 lh-copy mb3">
            Not only does having a criminal record pose immediate financial and
            physical insecurities, but it also creates psychological and mental
            burdens that can create a negative feedback loop of
            disenfranchisement. To mitigate these burdens, legal affirmation of
            having a “clean slate” can be a huge signal to them that they are
            re-welcomed into society.
          </p>
          <p className="f4 lh-copy mb3">
            ...
            the analysis process more efficient and accurate. We are working to
            make expungement analysis more accessible to potential beneficiaries
            by empowering a growing network of partner organizations across
            Oregon.
          </p>
          <p className="f4 lh-copy mb3">
            As an all-volunteer effort, RecordSponge remains an open opportunity
            for any who want to contribute to our mission.
          </p>
        </div>
      </div>
      ...
      <div className="bg-navy pv6">
        <div className="flex-l justify-between mw8 center white pa4">
          <div className="w-50-l bt bw2 b--blue pt4 mr5-l mb5">
            <h4 className="f3 f2-ns fw9 lh-title mt0 mb4">Clear your record</h4>
            <Link
          ...
          <div className="w-50-l bt bw2 b--blue pt4 ml5-l mb5">
            <h4 className="f3 f2-ns fw9 lh-title mt0 mb4">Use our software</h4>
