      ...
      <article className="order-1 lh-copy">
        <section className="mb5">
          ...
          <p className="mb4 mw7">
            ...
            listed here, and will use the Stock Form for those not listed. You
            can also fill out the forms manually if preferred.{" "}
          ...
          <div className="bg-white shadow pa3">
            ...
            <ul className="list ml2">
              ...
              <li className="mb3">
                ...
                >
                  Arrested and charged in Court but later dismissed or acquitted
                  of charge(s) <span className="f7 fw7">PDF</span>
                </a>
              </li>
            </ul>
          </div>
          <div className="bg-white shadow pa3">
            ...
            <ul className="list ml2">
              ...
              <li className="mb3">
                <a className="bb hover-blue" href="/docs/Clackamas-Arrest.pdf">
          ...
          <div className="bg-white shadow pa3">
            ...
            <ul className="list ml2">
              ...
              <li className="mb3">
                ...
                >
                  Arrested and a case filed with the Court but later charge(s)
                  were dismissed or acquitted{" "}
                  <span className="f7 fw7">PDF</span>
                </a>
              </li>
            </ul>
