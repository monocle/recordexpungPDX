...
const rawDemoRecord = demoResponse.record;

const demoRecord: RecordData = {
  total_balance_due: rawDemoRecord.total_balance_due,
  cases: rawDemoRecord.cases,
  errors: rawDemoRecord.errors,
  summary: rawDemoRecord.summary,
};
