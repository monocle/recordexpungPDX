      ...
      <>
        ...
        <div className="mw7 center lh-copy ph4 mt5 mb6">
          <main>
            ...
            <p className="mb3">
              RecordSponge is committed to ensuring digital accessibility for
              all people. We strive to meet level AA standards from the{" "}
              <a
            ...
            <p className="mb3">
              ...
              conformance: Level A, Level AA, and Level AAA. RecordSponge is
              largely conformant with WCAG 2.1 level AA. We’re working to bridge
              the remaining gaps.
            </p>
