    ...
    <main className="flex-l mw8 center ph4 mt5">
      ...
      <article className="order-1 lh-copy">
        <section className="mb5">
          ...
          <p className="mb3">
            RecordSponge is a volunteer-built web application used to facilitate
            the expungement process in Oregon. It is a collaboration between{" "}
            <a
          ...
          <p className="mb3">
            ...
            of Oregonians who are eligible to expunge their records have done
        ...
        <section className="mb5">
          ...
          <p className="mb3">
            ...
            timeline. Nevertheless, the complexity of the expungement statutes,
            ORS{" "}
            <a
              className="bb hover-blue"
            ...
            their own. Few organizations outside of the metropolitan area are
            equipped to perform expungement services, and the market rate to
            hire an attorney is over $1,400 <em>per case</em>.
          </p>
          <p className="mb3">RecordSponge is and always will be free to use.</p>
          <p className="mb4">
          ...
          <div className="bg-gray-blue-2 shadow br3 pa3 mb4">
            ...
            <ol className="ml4">
              <li className="mb2">
                The juvenile record is 5+ years old and the client hasn’t had
                subsequent criminal cases.
              </li>
              <li className="mb2">
                The client requests a hearing and demonstrates that it would be
                in the “best interests of justice” to expunge the record.
              </li>
            </ol>
          </div>
        </section>
        <section className="mb5">
          ...
          <ol className="ml4">
            ...
            <li className="mb3">Mail in fingerprints to Oregon State Police</li>
          </ol>
        </section>
        <section className="mb5">
          ...
          <p className="fw7 mb3">
            Before delivering expungement analysis, ensure that this assumption
            is met.
          </p>
          <p></p>
          <p className="mb3">
            RecordSponge only has access to online records of Oregon’s Circuit
            courts. However, having an open case or a conviction{" "}
          ...
          <ol className="ml4 mb4">
            <li className="fw7 mb3">
              The client does not have any open cases in any court in the United
              States.
            ...
            <li className="fw7 mb3">
              ...
              <ul className="list fw4 mb3">
                ...
                <li className="mb3">
                  ...
                  Accordingly, RecoredSponge’s analysis may not be accurate if a
                  person has a case previously expunged, and that case is from
                  the last 7 years. Note that this rule does not prevent a
                  person from filing for expungement multiple times within the
                  same 7 year period.
                </li>
                <li className="mb3">
                  Again, beware of convictions for misdemeanor/felony traffic
                  violations, e.g. Beaverton Municipal Court (not Washington
                  Circuit Court), Troutdale Municipal Court, Medford Municipal
                  Court, These courts generally handle low-level crimes and
                  especially traffic crimes. We only need to worry about
                  misdemeanor and felonies, including for Driving While
                  Suspended.
                </li>
              </ul>
            </li>
          ...
          <div className="bg-gray-blue-2 shadow br3 pa3 mb4">
            ...
            <ol className="ml4">
              ...
              <li className="mb2">
                Does the client have any criminal convictions in States besides
                Oregon from the last seven years?
              </li>
            </ol>
          </div>
          <p>
            If the Assumption is not met, but you would still like to conduct an
            analysis, or if you have any questions about this section, please
        ...
        <section className="mb5">
          ...
          <p className="mb3">
            Enter the person’s first and last name and date of birth into the
            search bar.
          </p>
          <p className="mb3">
            If the person has a previous name, alias, maiden name, etc., select
            the option to “Add Alias” and fill out another search.
          </p>
          <p className="mb3">
          ...
          <div className="bg-gray-blue-2 shadow br3 pa3 mb5">
            ...
            <p className="mb3">
              Courts often input incorrect information, and certain cases will
              not show all results. If an anticipated case does not show, also
              perform a search of the person’s first initial followed by a *,
              the person’s first three letters of their last name followed by a
              *, and their date of birth. For example, a search for Michael
              Zhang with birthdate 5/9/1993 would be M*, Zhang*, 5/9/1993.
            </p>
            <p className="mb2">
              ...
              McDonald could be input as Mc Donald (with a space) or McDonald
              (without a space). You would therefore need to search under both
              forms of the name to see which the court system has used.
            </p>
          </div>
          ...
          <div className="bg-white shadow pa3">
            ...
            <p className="mb3">
              ...
              being true. Having other cases could push out the eligibility date
              further.
            </p>
            <div className="dark-blue bg-washed-blue fw6 pv2 ph3 mb3 dib br3">
              Eligibility date dependent on open charge: Eligible Jun 12, 2022
              or 7 years from conviction of open charge
            </div>
            <p className="mb3">
              If there is an open charge, the affected charges will show
              multiple possible eligibity timeframes. Once the open charge is
              closed then the analysis will update. You can edit the open
          ...
          <div className="bg-white shadow pa3">
            ...
            <p className="mb3">
              Sometimes, there is not enough information on the OECI website to
              determine whether or not a case is eligible. RecordSponge will
              then prompt the user to answer questions, and the analysis will
              update based on those answers.
            </p>
          </div>
          <div className="bg-white shadow pa3 mb4">
            ...
            <p className="mb3">
              The specific charge is not eligible under the current law because
              it is not “type-eligible.” The reason why the charge is not
              type-eligible is different for each charge. This is not
        ...
        <section className="mb5">
          ...
          <p className="mb3">
            If a client has eligible charges, the Summary panel will display a
            button to Generate Paperwork. Click the button and you will be
            directed to input identifying information. Complete all fields.
          </p>
          <p className="mb4">
            After you input the information, RecordSponge will generate a .zip
            file with PDFs of the expungement paperwork for all of the charges,
            with one PDF file for each case that has eligible charges.
          </p>
          <p className="mb4">
          ...
          <ul className="ml4 mb3">
            <li className="mb2">
              Lee Inkless Fingerprint Pad (available on Amazon), $17 for 3 pack
              which can serve several hundred people
            </li>
            <li className="mb2">
              Fingerprint Cards, Applicant FD-258 (available on Amazon), $21 for
              a 50 pack
            </li>
          </ul>
          ...
          <p className="mb3">
            Included in your expungement packet should be a form titled: "Oregon
            State Police REQUEST FOR SET ASIDE CRIMINAL RECORD CHECK."
          </p>
          <p className="mb3">
          ...
          <p className="mb3">
            If you are seeking expungement of at least one conviction, you will
            need to include a check or money order made out to "Oregon State
            Police" for $33.
          </p>
          ...
          <ul className="ml4 mb3">
            <li className="mb2">
              You will need to file the paperwork with the courthouse in each
              county in which you have cases you wish to expunge. File with the
              Clerk of court. There should be no filing fee.
            </li>
          ...
          <ul className="ml4 mb3">
            <li className="mb2">
              ...
              michael@qiu-qiulaw.com immediately so that we can assist you. Even
              if we do not represent you in court, we will still be able to
              assist you.
            </li>
            <li className="mb2">
              By law, the District Attorney is required to respond within four
              months after you file. If you receive communication during this
              time from the District Attorney that you would like to review with
              us, please email us at roe@qiu-qiulaw.com
            </li>
            <li className="mb2">
            ...
            <li className="mb2">
              ...
              your expungement. This is available at{" "}
              <a
